...
<!-- Modal -->
<div class="modal fade" id="leaveModal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="col-md-10">
            <button type="button" class="btn btn-success col-sm-3 col-xs-5 btn-margin approve" title="Approve"><i class="fa fa-thumbs-up"></i><span>Approve</span>
            </button>
            <button type="button" class="btn btn-primary col-sm-3 col-xs-5 btn-margin disapprove" title="Disapprove"><i class="fa fa-thumbs-down"></i><span>Disapprove</span>
            </button>
            <button type="button" class="btn btn-danger col-sm-3 col-xs-5 btn-margin cancel" title="Cancel"><i class="fa fa fa-close"></i><span>Cancel</span>
            </button>
          </div>
        </div>
</div>
