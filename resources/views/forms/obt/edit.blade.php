                ...
                <div class="panel-body">
                    <form class="form-horizontal edit-form" role="form" method="POST" action="{{ route('forms.update', ['id' => $form->id, 'action_id']) }}">
                        ...
                        <div class="form-group{{ $errors->has('date_to') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group date">
                                    ...
                                    <input type="text" value="{{$form->date_to}}" name="date_to" class="form-control pull-right datepicker" id="datetimeTo" required>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('starttime') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group bootstrap-timepicker">
                                    ...
                                    <input type="text" value="{{$form->starttime}}" name="starttime" class="form-control pull-right timepicker" id="startTime" required>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('endtime') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group bootstrap-timepicker">
                                    ...
                                    <input type="text" value="{{$form->endtime}}" name="endtime" class="form-control pull-right timepicker" id="endTime" required>
                                </div>
                        ...
                        <div class="form-group{{ $errors->has('company_to_visit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$form->company_to_visit}}" class="form-control" rows="5" id="company_to_visit" name="company_to_visit" required>
                        ...
                        <div class="form-group{{ $errors->has('company_location') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$form->company_location}}" class="form-control" rows="5" id="company_location" name="company_location" required>
                        ...
                        <div class="form-group{{ $errors->has('contact_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$form->contact_name}}" class="form-control" rows="5" id="contact_name" name="contact_name" required>
                        ...
                        <div class="form-group{{ $errors->has('contact_info') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$form->contact_info}}" class="form-control" rows="5" id="contact_info" name="contact_info" required>
                        ...
                        <div class="form-group{{ $errors->has('contact_position') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$form->contact_position}}" class="form-control" rows="5" id="contact_position" name="contact_position" required>
