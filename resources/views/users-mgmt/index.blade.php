...
<section class="content">
  ...
  <div class="box-header">
    <div class="row">
        <div class="col-sm-8">
          <h3 class="box-title">List of Users {{$user->employee_id}}</h3>
        </div>
        <div class="col-sm-4">
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('user-management.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['Username', 'Email'], 
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Username</th>
            ...
            <tfoot>
              <tr>
                <th class="hidden-xs" width="20%" rowspan="1" colspan="1">Name</th>
